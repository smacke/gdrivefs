...
public final class DownloadTask {
  ...
  public static final int MAXIMUM_CHUNK_SIZE = 32 * MB;
  ...
  /**
   * Construct the {@link DownloadTask}.
   *
   * @param transport The transport to use for requests
   * @param httpRequestInitializer The initializer to use when creating an {@link HttpRequest} or
   *        {@code null} for none
   */
  public DownloadTask(Database db, HttpTransport transport, HttpRequestInitializer httpRequestInitializer) {
   ...
   *
   * <p>
   * This method is not reentrant. A new instance of {@link DownloadTask} must be
...
//TODO:      updateStateAndNotifyListener(DownloadState.MEDIA_IN_PROGRESS);
    ...
    //TODO:     updateStateAndNotifyListener(DownloadState.MEDIA_COMPLETE);
      return;
    }
   ...
   */
  public DownloadTask setBytesDownloaded(long bytesDownloaded) {
   ...
   * @since 1.13
   */
  public DownloadTask setContentRange(long firstBytePos, int lastBytePos) {
   ...
   * protocol to download in data chunks. Defaults to {@code false}.
   */
  public DownloadTask setDirectDownloadEnabled(boolean directDownloadEnabled) {
   ...
   */
  public DownloadTask setProgressListener(
  ...
  @Beta
  @Deprecated
  public DownloadTask setBackOffPolicyEnabled(boolean backOffPolicyEnabled) {
   ...
   * </p>
   */
  public DownloadTask setChunkSize(int chunkSize) {
